...
insert into ss_user (id, login_name, name, password, salt, roles, register_date, email) values(1,'admin','Admin','691b14d79bf0fa2215f155235df5e670b64394cc','7efbd59d9741d34f','admin','2012-06-04 01:00:00','admin@springside.org.cn');
insert into ss_user (id, login_name, name, password, salt, roles, register_date, email) values(2,'user','Calvin','2488aa0c31c624687bd9928e0a5d29e7d1ed520b','6d65d24122c30500','user','2012-06-04 02:00:00','user@springside.org.cn');