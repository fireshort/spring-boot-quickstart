...
挖财专家[王福强](http://afoo.me/whoami.html)不错的Spring Boot入门文章。关于logging部分需要更新，新版Spring Boot默认使用logback，spring-boot-starter-logging、spring-boot-starter-log4j、spring-boot-starter-log4j2已经没有。
